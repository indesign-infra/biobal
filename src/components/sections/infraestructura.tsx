...
export const Infraestructura = component$(() => {
  return (
    <Section id="infraestructura" tone="white">
      <Container>
        <SectionTitle
          align="center"
          eyebrow="Infraestructura y servicios"
          title="Todo lo que necesitás para desarrollar tu actividad"
          subtitle="Servicios e instalaciones pensados para que te enfoques en tu profesión y tus pacientes."
        />
          ...
          {benefits.map(({ label, Icon, premium }) => (
            ...
            >
              ...
              <span class="text-ink-strong text-sm font-medium">
                {label}
                {premium && (
                  <span class="ml-1.5 align-middle" title="Servicio destacado">
                    ✨
                  </span>
                )}
              </span>
