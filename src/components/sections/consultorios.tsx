...
export const Consultorios = component$(() => {
  return (
    <Section id="consultorios" tone="surface">
      <Container>
        <div class="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          <div>
            <SectionTitle
              eyebrow="Consultorios profesionales"
              title="Espacios listos para comenzar a atender"
              subtitle="Consultorios en alquiler para distintas especialidades médicas y terapéuticas. Cada espacio está diseñado para ofrecer comodidad, privacidad y funcionalidad."
            />
