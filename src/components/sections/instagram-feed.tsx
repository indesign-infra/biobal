...
type InstagramFeedProps = { posts: IgPost[] };

export const InstagramFeed = component$<InstagramFeedProps>(({ posts }) => {
    ...
    <Section id="instagram" tone="surface">
      <Container>
        <div class="flex flex-col items-center justify-between gap-5 sm:flex-row">
          <div>
            <p class="text-accent-600 mb-2 text-sm font-semibold tracking-[0.14em] uppercase">
              Comunidad · Novedades
            </p>
