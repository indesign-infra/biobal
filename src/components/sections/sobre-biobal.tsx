    ...
    <Section id="sobre" tone="white">
      <Container class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div class="order-1 lg:order-2">
          <SectionTitle
            eyebrow="Sobre BioBal"
            title="Un espacio que potencia tu trabajo y la experiencia del paciente"
          />
          <p class="text-ink mt-5 text-base leading-relaxed sm:text-lg">
            Creemos que el entorno donde se desarrolla la atención médica
            influye directamente en la experiencia del profesional y del
            paciente. Por eso creamos un espacio que reúne tecnología, confort,
            accesibilidad y servicios complementarios, permitiendo que cada
            especialista se enfoque plenamente en su actividad.
          </p>
