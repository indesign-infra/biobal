...
export const BioBanco = component$(() => {
  return (
          ...
          <div class="relative grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:items-center lg:gap-16">
            <div>
              ...
              <h2 class="font-display mt-5 text-3xl font-semibold text-white sm:text-4xl">
                Bio Banco de Tejidos
              </h2>
              <p class="text-primary-100/90 mt-5 text-base leading-relaxed sm:text-lg">
                Dentro de las instalaciones de BioBal funciona Bio Banco de
                Tejidos, una unidad especializada que forma parte del ecosistema
                de servicios de salud de la institución. Su actividad se orienta
                a la gestión, procesamiento y conservación de tejidos bajo
                estrictos estándares de calidad, contribuyendo al desarrollo de
                soluciones innovadoras para el ámbito sanitario y reforzando el
                compromiso de BioBal con la excelencia y la innovación en salud.
              </p>
            </div>
